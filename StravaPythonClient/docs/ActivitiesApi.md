...
photo_ids = NULL # object | List of native photo ids to attach to the activity. (optional)
 ...
 **photo_ids** | [**object**](.md)| List of native photo ids to attach to the activity. | [optional] 
